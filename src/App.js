...
function App() {
  ...
  const [interestRate, setInterestRate] = useState("7.375");
  ...
  if (deviceWidth > 800) {
        ...
        <div className="headingContainer">
          <div className="bannerContainer">
            ...
            <div>
              ...
              >
                This is a breakdown of your first monthly payment. Future
                payments will change over time. Connect with your agent
                for&nbsp;more information on amortization details.
              </p>
            </div>
          </div>
          <div>
    ...
    return (
      <div style={{ backgroundColor: "white" }}>
        ...
        <div style={{ backgroundColor: "#002a4e", padding: "10px 20px" }}>
          <div
            style={{
              display: "grid",
              gridTemplateColumns: "8% 92%",
